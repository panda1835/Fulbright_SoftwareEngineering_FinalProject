...
public class RoleUtils {
    public static final List<PermissionsEnum> ADMIN_PERMISSION = new ArrayList<>(Arrays.asList(PermissionsEnum.values()));
    ...
    public static final List<PermissionsEnum> GUEST_PERMISSION = new ArrayList<>(Collections.singletonList(PermissionsEnum.GET_COURSE));
